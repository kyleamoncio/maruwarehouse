...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    } else if (["repairRestockDamage", "repairRestockRows", "repairV2OrderCosts", "refreshProductView", "refreshLatestFirstViews", "formatV2", "applyRequestedLayout", "applyApprovedSmPrices"].includes(action)) {
